...
const allMembers: { grade: string; name: string; dest: string; type: string; qq?: string }[] = [
  ...
  { grade: '2022', name: '陈信豪', dest: '', type: '', qq: '' },
  { grade: '2022', name: '杨东明', dest: '', type: '', qq: '' },
  { grade: '2022', name: '李焕然', dest: '', type: '', qq: '' },
  { grade: '2022', name: '罗永霖', dest: '', type: '', qq: '' },
  { grade: '2022', name: '陈双彬', dest: '', type: '', qq: '' },
  { grade: '2022', name: '杨博飞', dest: '', type: '', qq: '' },
  { grade: '2022', name: '隋炀', dest: '', type: '', qq: '' },

  { grade: '2021', name: '赵泽熙', dest: '', type: '', qq: '' },
  { grade: '2021', name: '张歆予', dest: '', type: '', qq: '' },
  { grade: '2021', name: '周蕊', dest: '', type: '', qq: '' },
  { grade: '2021', name: '王艺钢', dest: '', type: '', qq: '' },
  { grade: '2021', name: '谯星宇', dest: '', type: '', qq: '' },
  { grade: '2021', name: '张浩然', dest: '', type: '', qq: '' },
  { grade: '2021', name: '任隽谦', dest: '', type: '', qq: '' },
  { grade: '2021', name: '李亚文', dest: '', type: '', qq: '' },
  { grade: '2021', name: '宋遗平', dest: '', type: '', qq: '' },
  { grade: '2021', name: '蒲俊彦', dest: '', type: '', qq: '' },
  { grade: '2021', name: '毛逸飞', dest: '', type: '', qq: '' },

  { grade: '2020', name: '赵耀东', dest: '', type: '', qq: '' },
  { grade: '2020', name: '何锦涛', dest: '', type: '', qq: '' },
  { grade: '2020', name: '沈俞佑', dest: '', type: '', qq: '' },
  { grade: '2020', name: '潘佳豪', dest: '', type: '', qq: '' },
  { grade: '2020', name: '石一峰', dest: '', type: '', qq: '' },
  { grade: '2020', name: '李航舟', dest: '', type: '', qq: '' },
  { grade: '2020', name: '袁云飞', dest: '', type: '', qq: '' },
  { grade: '2020', name: '张新云', dest: '', type: '', qq: '' },
  { grade: '2020', name: '孙钰镒', dest: '', type: '', qq: '' },

  { grade: '2019', name: '刘洪堃', dest: '', type: '', qq: '' },
  { grade: '2019', name: '赵宇', dest: '', type: '', qq: '' },
  { grade: '2019', name: '岳筱涵', dest: '', type: '', qq: '' },
  { grade: '2019', name: '曹志鹏', dest: '', type: '', qq: '' },
  { grade: '2019', name: '黎达', dest: '', type: '', qq: '' },
  { grade: '2019', name: '蒋曾慧', dest: '', type: '', qq: '' },
  { grade: '2019', name: '赵千', dest: '', type: '', qq: '' },
  { grade: '2019', name: '徐燕', dest: '', type: '', qq: '' },
  { grade: '2019', name: '廖小菊', dest: '', type: '', qq: '' },
  { grade: '2019', name: '姜自友', dest: '', type: '', qq: '' },
  { grade: '2019', name: '朱珂江', dest: '', type: '', qq: '' },
  { grade: '2019', name: '贺邈婵', dest: '', type: '', qq: '' },
  { grade: '2019', name: '王萌', dest: '', type: '', qq: '' },
  { grade: '2019', name: '叶尤晟', dest: '', type: '', qq: '' },
]
