    ...
    <section id="section-8" ref={ref} className="relative flex min-h-screen items-center overflow-hidden bg-gray-100 px-6">
      ...
      <div className="relative z-10 ml-0 md:ml-28 w-full max-w-4xl text-left">
        ...
        <div className="flex flex-col items-start justify-between gap-6 md:flex-row md:items-end">
          ...
          <div className="body-p mr-0 flex flex-col items-center gap-1 md:mr-12" style={{ opacity: 0, transform: 'translateY(24px)', transition: 'opacity .8s cubic-bezier(0.76,0,0.24,1) .8s, transform .8s cubic-bezier(0.76,0,0.24,1) .8s' }}>
        ...
        <blockquote className="body-p mt-10 max-w-[1000px] border-l-2 border-accent pl-5 font-misans-light text-[1rem] leading-[1.75] text-gray-400 italic" style={{ opacity: 0, transform: 'translateY(24px)', transition: 'opacity .8s cubic-bezier(0.76,0,0.24,1) .85s, transform .8s cubic-bezier(0.76,0,0.24,1) .85s' }}>
