  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 ml-0 w-full max-w-4xl text-left md:ml-28">
              ...
              {['电子科技大学', '重庆大学', '天津大学', '北京航空航天大学'].map((s, i) => (
                <li
                  ...
                  style={{
                    opacity: 0,
                    transform: 'translateY(24px)',
                    transition: `opacity .8s cubic-bezier(0.76,0,0.24,1) ${0.4 + i * 0.1}s, transform .8s cubic-bezier(0.76,0,0.24,1) ${0.4 + i * 0.1}s`,
                  }}
                >
              ...
              {['字节跳动', '腾讯', '阿里巴巴', '美团'].map((s, i) => (
                <li
                  ...
                  style={{
                    opacity: 0,
                    transform: 'translateY(24px)',
                    transition: `opacity .8s cubic-bezier(0.76,0,0.24,1) ${0.5 + i * 0.1}s, transform .8s cubic-bezier(0.76,0,0.24,1) ${0.5 + i * 0.1}s`,
                  }}
                >
                  <span className="mr-3 font-bebas text-lg text-accent">—</span>
                  <strong className="font-semibold text-gray-800">{s}</strong>
        ...
        <blockquote
          className="body-p mt-8 max-w-[1100px] border-l-2 border-accent pl-5 font-misans-light text-[1rem] leading-[1.75] text-gray-400 italic"
          style={{
            opacity: 0,
            transform: 'translateY(24px)',
            transition:
